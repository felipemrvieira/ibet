...
class BetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bet" do
    assert_difference('Bet.count') do
      post bets_url, params: { bet: { bettor_id: @bet.bettor_id, game_id: @bet.game_id, time: @bet.time } }
    end
  ...
  test "should update bet" do
    patch bet_url(@bet), params: { bet: { bettor_id: @bet.bettor_id, game_id: @bet.game_id, time: @bet.time } }
